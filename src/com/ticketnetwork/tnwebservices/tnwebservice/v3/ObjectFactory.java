 ...
 * generated in the com.ticketnetwork.tnwebservices.tnwebservice.v3 package. 
...
public class ObjectFactory {
    ...
    private final static QName _ArrayOfTicketGroup_QNAME = new QName("http://tnwebservices.ticketnetwork.com/tnwebservice/v3.0", "ArrayOfTicketGroup");
    private final static QName _ArrayOfCountry_QNAME = new QName("http://tnwebservices.ticketnetwork.com/tnwebservice/v3.0", "ArrayOfCountry");
    private final static QName _PricingInformation_QNAME = new QName("http://tnwebservices.ticketnetwork.com/tnwebservice/v3.0", "PricingInformation");
    private final static QName _ArrayOfEvent_QNAME = new QName("http://tnwebservices.ticketnetwork.com/tnwebservice/v3.0", "ArrayOfEvent");
    private final static QName _ArrayOfCategory_QNAME = new QName("http://tnwebservices.ticketnetwork.com/tnwebservice/v3.0", "ArrayOfCategory");
    private final static QName _ArrayOfEventPerformer_QNAME = new QName("http://tnwebservices.ticketnetwork.com/tnwebservice/v3.0", "ArrayOfEventPerformer");
    private final static QName _ArrayOfPerformerPercent_QNAME = new QName("http://tnwebservices.ticketnetwork.com/tnwebservice/v3.0", "ArrayOfPerformerPercent");
    private final static QName _ArrayOfStates_QNAME = new QName("http://tnwebservices.ticketnetwork.com/tnwebservice/v3.0", "ArrayOfStates");
    private final static QName _ArrayOfPerformer_QNAME = new QName("http://tnwebservices.ticketnetwork.com/tnwebservice/v3.0", "ArrayOfPerformer");
    private final static QName _Country_QNAME = new QName("http://tnwebservices.ticketnetwork.com/tnwebservice/v3.0", "Country");
    private final static QName _ArrayOfVenue_QNAME = new QName("http://tnwebservices.ticketnetwork.com/tnwebservice/v3.0", "ArrayOfVenue");
    private final static QName _ArrayOfVenueConfiguration_QNAME = new QName("http://tnwebservices.ticketnetwork.com/tnwebservice/v3.0", "ArrayOfVenueConfiguration");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.ticketnetwork.tnwebservices.tnwebservice.v3
     * 
     */
    ...
    /**
     * Create an instance of {@link GetPricingInfo }
     * 
     */
    public GetPricingInfo createGetPricingInfo() {
        return new GetPricingInfo();
    }
    ...
    /**
     * Create an instance of {@link ArrayOfStates }
     * 
     */
    public ArrayOfStates createArrayOfStates() {
        return new ArrayOfStates();
    }
    ...
    /**
     * Create an instance of {@link GetPricingInfoResponse }
     * 
     */
    public GetPricingInfoResponse createGetPricingInfoResponse() {
        return new GetPricingInfoResponse();
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tnwebservices.ticketnetwork.com/tnwebservice/v3.0", name = "ArrayOfTicketGroup")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tnwebservices.ticketnetwork.com/tnwebservice/v3.0", name = "ArrayOfCountry")
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link PricingInformation }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://tnwebservices.ticketnetwork.com/tnwebservice/v3.0", name = "PricingInformation")
    public JAXBElement<PricingInformation> createPricingInformation(PricingInformation value) {
        return new JAXBElement<PricingInformation>(_PricingInformation_QNAME, PricingInformation.class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tnwebservices.ticketnetwork.com/tnwebservice/v3.0", name = "ArrayOfEvent")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tnwebservices.ticketnetwork.com/tnwebservice/v3.0", name = "ArrayOfCategory")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tnwebservices.ticketnetwork.com/tnwebservice/v3.0", name = "ArrayOfEventPerformer")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tnwebservices.ticketnetwork.com/tnwebservice/v3.0", name = "ArrayOfPerformerPercent")
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link ArrayOfStates }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://tnwebservices.ticketnetwork.com/tnwebservice/v3.0", name = "ArrayOfStates")
    public JAXBElement<ArrayOfStates> createArrayOfStates(ArrayOfStates value) {
        return new JAXBElement<ArrayOfStates>(_ArrayOfStates_QNAME, ArrayOfStates.class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tnwebservices.ticketnetwork.com/tnwebservice/v3.0", name = "ArrayOfPerformer")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tnwebservices.ticketnetwork.com/tnwebservice/v3.0", name = "Country")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tnwebservices.ticketnetwork.com/tnwebservice/v3.0", name = "ArrayOfVenue")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tnwebservices.ticketnetwork.com/tnwebservice/v3.0", name = "ArrayOfVenueConfiguration")
